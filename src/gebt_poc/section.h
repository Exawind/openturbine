...
public:
    Section()
        : name_(""), location_(0.), mass_matrix_(View2D_6x6("mass matrix")), stiffness_matrix_("stiffness matrix") {}

    Section(std::string name, double location, MassMatrix mass_matrix, View2D_6x6 stiffness_matrix)    
    : name_(name),
      location_(location),

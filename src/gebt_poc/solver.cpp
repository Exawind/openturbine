...
void CalculateInertialForces(
    ...
    // Calculate the first part of the inertial forces vector
    auto inertial_forces_fc_1 = Kokkos::subview(inertial_forces_fc, Kokkos::make_pair(0, 3));
    Kokkos::deep_copy(inertial_forces_fc_1, 0.);
    ...
    // Calculate the second part of the inertial forces vector
    auto inertial_forces_fc_2 = Kokkos::subview(inertial_forces_fc, Kokkos::make_pair(3, 6));
    Kokkos::deep_copy(inertial_forces_fc_2, 0.);

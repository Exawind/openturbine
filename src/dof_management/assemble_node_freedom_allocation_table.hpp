...
inline void assemble_node_freedom_allocation_table(
    ...
    Kokkos::parallel_for(
        "AssembleNodeFreedomMapTable_Beams", Kokkos::RangePolicy<typename DeviceType::execution_space>(0, elements.beams.num_elems),
    ...
    Kokkos::parallel_for(
        "AssembleNodeFreedomMapTable_Masses", Kokkos::RangePolicy<typename DeviceType::execution_space>(0, elements.masses.num_elems),
    ...
    Kokkos::parallel_for(
        "AssembleNodeFreedomMapTable_Springs", Kokkos::RangePolicy<typename DeviceType::execution_space>(0, elements.springs.num_elems),
    ...
    Kokkos::parallel_for(
        "AssembleNodeFreedomMapTable_Constraints", Kokkos::RangePolicy<typename DeviceType::execution_space>(0, constraints.num_constraints),
    ...
    Kokkos::parallel_for(
        "ComputeActiveDofs", Kokkos::RangePolicy<typename DeviceType::execution_space>(0, state.num_system_nodes),

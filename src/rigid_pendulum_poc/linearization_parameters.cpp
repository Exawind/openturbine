...
Kokkos::View<double*> UnityLinearizationParameters::ResidualVector(
    [[maybe_unused]] const Kokkos::View<double*> gen_coords,
    [[maybe_unused]] const Kokkos::View<double*> velocity, const Kokkos::View<double*> acceleration,
...
Kokkos::View<double**> UnityLinearizationParameters::IterationMatrix(
    ...
    [[maybe_unused]] const Kokkos::View<double*> gen_coords,
    [[maybe_unused]] const Kokkos::View<double*> delta_gen_coords,
    [[maybe_unused]] const Kokkos::View<double*> velocity,
    [[maybe_unused]] const Kokkos::View<double*> acceleration,
    const Kokkos::View<double*> lagrange_mults
) {

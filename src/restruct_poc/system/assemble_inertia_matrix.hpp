...
inline void AssembleInertiaMatrix(Beams& beams, double beta_prime, double gamma_prime, Kokkos::View<double***> M) {
    ...
    // const auto coeff_size =  Kokkos::View<double***>::shmem_size(max_elem_nodes, max_elem_nodes, max_elem_qp);
    // range_policy.set_scratch_size(1, Kokkos::PerTeam(coeff_size));

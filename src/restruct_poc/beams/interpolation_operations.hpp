...
template <typename shape_matrix_type>
KOKKOS_INLINE_FUNCTION void InterpVector3(
    const shape_matrix_type& shape_matrix, const View_Nx3::const_type& node_v, const View_Nx3& qp_v
) {
...
KOKKOS_INLINE_FUNCTION void InterpVector4(
    const shape_matrix_type& shape_matrix, const View_Nx4::const_type& node_v, const View_Nx4& qp_v
) {
    for (int j = 0; j < qp_v.extent_int(0); ++j) {
...
template <typename shape_matrix_type, typename jacobian_type>

...
struct RotateSectionMatrix {
    ...
    void operator()() const {
        const auto RR0 =
            Kokkos::subview(qp_RR0_, i_elem, Kokkos::make_pair(0, 3), Kokkos::make_pair(0, 3));
        const auto Cstar_top =
            Kokkos::subview(qp_Cstar_, i_elem, Kokkos::make_pair(0, 3), Kokkos::ALL);
        const auto Cstar_bottom =
            Kokkos::subview(qp_Cstar_, i_elem, Kokkos::make_pair(3, 6), Kokkos::ALL);

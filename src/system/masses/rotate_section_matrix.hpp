...
KOKKOS_FUNCTION
inline void RotateSectionMatrix(const Kokkos::View<double[4]>::const_type& xr, const Kokkos::View<double[6][6]>::const_type& Cstar, const Kokkos::View<double[6][6]>& Cuu) {

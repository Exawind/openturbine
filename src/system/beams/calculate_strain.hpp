...
KOKKOS_INLINE_FUNCTION void CalculateStrain(
    ...
    auto R_x0_prime = Kokkos::View<double[3], DeviceType>(R_x0_prime_data.data());
    ...
    auto E = Kokkos::View<double[3][4], DeviceType>(E_data.data());
    QuaternionDerivative(r, E);
    auto e2_data = Kokkos::Array<double, 4>{};
    auto e2 = Kokkos::View<double[4], DeviceType>{e2_data.data()};

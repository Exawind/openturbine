...
namespace openturbine::interfaces::components {
    ...
    TurbineBuilder& TurbineBuilder::SetYawBearingInertiaMatrix(const std::array<std::array<double, 6>, 6>& matrix) {
        this->input.yaw_bearing_inertia_matrix = matrix;
        return *this;
    }

    TurbineBuilder& TurbineBuilder::SetHubInertiaMatrix(const std::array<std::array<double, 6>, 6>& matrix) {

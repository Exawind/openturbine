...
struct MooringLineInput {
    ...
    Array_3 fairlead_position{0., 0., 0.};

    /// Fairlead point velocity (XYZ)
    Array_3 fairlead_velocity{0., 0., 0.};

    /// Fairlead point acceleration (XYZ)
    Array_3 fairlead_acceleration{0., 0., 0.};

    /// Anchor point coordinates (XYZ)
    Array_3 anchor_position{0., 0., 0.};

    /// Anchor point velocity (XYZ)
    Array_3 anchor_velocity{0., 0., 0.};

    /// Anchor point acceleration (XYZ)
    Array_3 anchor_acceleration{0., 0., 0.};
};

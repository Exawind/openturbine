...
Outputs::OutputLocation Outputs::GetLocation() const { return this->location_; }
    ...
    void Outputs::WriteRotorTimeSeriesAtTimestep(size_t timestep, double azimuth_angle, double rotor_speed) {

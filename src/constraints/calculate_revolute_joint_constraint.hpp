...
inline void CalculateRevoluteJointConstraint(const Kokkos::View<double[3]>::const_type& X0, const Kokkos::View<double[3][3]>::const_type& axes, const Kokkos::View<double[7]>::const_type& base_node_u, const Kokkos::View<double[7]>::const_type& target_node_u, const Kokkos::View<double[6]>& residual_terms, const Kokkos::View<double[6][6]>& base_gradient_terms, const Kokkos::View<double[6][6]>& target_gradient_terms) {
        ...
        const auto R2_data = Kokkos::Array<double, 4>{target_node_u(3), target_node_u(4), target_node_u(5), target_node_u(6)};

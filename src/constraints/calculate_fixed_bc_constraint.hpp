...
KOKKOS_FUNCTION
inline void CalculateFixedBCConstraint(const Kokkos::View<double[3]>::const_type& X0, const Kokkos::View<double[7]>::const_type& node_u, const Kokkos::View<double[6]>& residual_terms, const Kokkos::View<double[6][6]>& target_gradient_terms) {

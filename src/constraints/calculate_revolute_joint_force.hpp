...
KOKKOS_FUNCTION
inline void CalculateRevoluteJointForce(const Kokkos::View<double[3][3]>::const_type& axes, const Kokkos::View<double[7]>::const_type& inputs, const Kokkos::View<double[7]>::const_type& node_u, const Kokkos::View<double[6]>& system_residual_terms) {

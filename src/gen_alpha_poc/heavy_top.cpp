...
//     const Kokkos::View<double*> acceleration_vector, const Kokkos::View<double*>
//     gen_forces_vector, const Kokkos::View<double*> lagrange_multipliers, const
//     Kokkos::View<double*> reference_position_vector
// ) {
//     // The residual vector for the generalized coordinates is given by
...
//     auto constraint_gradient_matrix = Kokkos::View<double**>(
...
//     const Kokkos::View<double*> velocity, [[maybe_unused]] const Kokkos::View<double*>
//     acceleration, const Kokkos::View<double*> lagrange_mults
// ) {
...
//     auto element4 = Kokkos::View<double**>("element4", size_constraints, size_constraints);

//     auto iteration_matrix = Kokkos::View<double**>("iteration_matrix", size, size);
//     Kokkos::parallel_for(
//         Kokkos::MDRangePolicy<Kokkos::DefaultExecutionSpace, Kokkos::Rank<2>>({0, 0}, {size,
//         size}), KOKKOS_LAMBDA(const size_t i, const size_t j) {
//             if (i < size_dofs && j < size_dofs) {
...
//     const Kokkos::View<double*> angular_velocity_vector, const Kokkos::View<double**>
//     inertia_matrix
// ) {
...
//         ),
//         KOKKOS_LAMBDA(const size_t i, const size_t j) {
//             nonzero_block(i, j) = nonzero_block_first_part(i, j) - nonzero_block_second_part(i,
//             j);
//         }
//     );
...
//     const Kokkos::View<double**> rotation_matrix, const Kokkos::View<double*>
//     lagrange_multipliers, const Kokkos::View<double*> reference_position_vector
// ) {
...
//     auto size = kNumberOfLieAlgebraComponents;
//     auto tangent_stiffness_matrix = Kokkos::View<double**>("tangent_stiffness_matrix", size,
...
//     const double phi =
//         std::sqrt(psi_host(0) * psi_host(0) + psi_host(1) * psi_host(1) + psi_host(2) *
//         psi_host(2));
...
//             multiply_matrix_with_scalar(psi_psi_matrix, (1.0 - std::sin(phi) / phi) / (phi *
//             phi));

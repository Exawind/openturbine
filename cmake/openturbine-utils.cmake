...
#         set_target_properties(${target} PROPERTIES LANGUAGE CUDA)
...
macro(generate_version_info)
    ...
    get_git_head_revision(OTURB_GITREFSPEC OTURB_GIT_COMMIT_SHA)
    if (OTURB_GIT_COMMIT_SHA)
        git_describe(OTURB_VERSION_TAG "--tags" "--always")
        git_local_changes(OTURB_REPO_DIRTY)
        option(OTURB_HAVE_GIT_INFO "Git version for OpenTurbine" ON)
        if (${OTURB_VERSION_TAG} MATCHES ".*-NOTFOUND")
            set(OTURB_VERSION_TAG "v0.0.1")
        endif()
    endif()
    string(TIMESTAMP OTURB_VERSION_TIMESTAMP "%Y-%m-%d %H:%M:%S (UTC)" UTC)

...
inline void WriteVTKBeamsQP(State& state, Beams& beams, const std::string& filename) {
    ...
    auto num_qps_per_element = Kokkos::create_mirror_view_and_copy(Kokkos::HostSpace(), beams.num_qps_per_element);
    ...
    auto qp_deformation = Kokkos::create_mirror_view_and_copy(Kokkos::HostSpace(), beams.qp_deformation);
...
inline void WriteVTKBeamsNodes(State& state, Beams& beams, const std::string& filename) {
    ...
    // Get a copy of the beam element indices in the host space
    auto num_nodes_per_element = Kokkos::create_mirror_view_and_copy(Kokkos::HostSpace(), beams.num_nodes_per_element);
    ...
    const auto node_u_dot = Kokkos::create_mirror_view_and_copy(Kokkos::HostSpace(), beams.node_u_dot);

...
TEST(Milestone, IEA15RotorAeroController) {
    ...
    auto host_state_x = Kokkos::create_mirror_view(state.x);
    auto host_state_q = Kokkos::create_mirror_view(state.q);
    auto host_state_v = Kokkos::create_mirror_view(state.v);
    auto host_state_vd = Kokkos::create_mirror_view(state.vd);

    // Host mirror of beam external forces
    auto host_node_FX = Kokkos::create_mirror_view(elements.beams.node_FX);
    ...
    auto host_qp_u_dot = Kokkos::create_mirror_view_and_copy(Kokkos::HostSpace(), elements.beams.qp_u_dot);
    auto host_qp_omega = Kokkos::create_mirror_view_and_copy(Kokkos::HostSpace(), elements.beams.qp_omega);
    auto host_qp_u_ddot = Kokkos::create_mirror_view_and_copy(Kokkos::HostSpace(), elements.beams.qp_u_ddot);
    auto host_qp_omega_dot = Kokkos::create_mirror_view_and_copy(Kokkos::HostSpace(), elements.beams.qp_omega_dot);
    auto host_qp_Fe = Kokkos::create_mirror_view(elements.beams.qp_Fe);

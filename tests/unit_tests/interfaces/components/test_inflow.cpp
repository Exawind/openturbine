...
TEST(InflowTest, SteadyWindWithoutShear) {
    ...
    double vel_h = 10.;
    double ref_height = 100.;
    double power_law_exp = 0.;
    double flow_angle_horizontal = 0.;
    auto inflow = interfaces::components::Inflow::SteadyWind(
        vel_h, ref_height, power_law_exp, flow_angle_horizontal
    );

    std::vector<TestCase> test_cases = {
        {0., {0., 0., 0.}, {10., 0., 0.}},          // Test case at time 0 and at ground level
        {1., {0., 0., ref_height}, {10., 0., 0.}},  // Test case at time 1 and at reference height
        {1000., {100., 100., 100.}, {10., 0., 0.}}  // Test case at time 1000 and at far away
    };
...
TEST(InflowTest, SteadyWindWithShearNonzeroFlowAngle) {
    ...
    double vel_h = 10.;
    double ref_height = 100.;
    double power_law_exp = 0.1;
    double flow_angle_horizontal = M_PI / 4.;  // 45 degrees -> radians
    ...
    std::vector<TestCase> test_cases = {
        ...
        {0., {0., 0., ref_height}, {7.0710678118654755, -7.0710678118654755, 0.}},
        // Test case at time 1 and at ground level
        {1., {0., 0., 0.}, {0., 0., 0.}},
        // Test case at time 100 and at half ref height
        {100., {100., 100., ref_height / 2.}, {6.597539553864471, -6.597539553864471, 0.}}
    };
...
TEST(InflowTest, SteadyWindWithShear) {
    ...
    std::vector<TestCase> test_cases = {
        // Test case at time 0 and at reference height
        {0., {0., 0., ref_height}, {10., 0., 0.}},
        // Test case at time 1 and at ground level
        {1., {0., 0., 0.}, {0., 0., 0.}},
        // Test case at time 100 and at half ref height
        {100., {100., 100., ref_height / 2.}, {9.330329915368074, 0., 0.}}
    };

...
TEST(CalculateInertiaStiffnessMatrixMassesTests, OneNode) {
    ...
    const auto omega_tilde = CreateView<double[3][3]>("omega_tilde", std::array{46., 47., 48., 49., 50., 51., 52., 53., 54.});
    const auto omega_dot_tilde = CreateView<double[3][3]>("omega_dot_tilde", std::array{55., 56., 57., 58., 59., 60., 61., 62., 63.});
    const auto rho = CreateView<double[3][3]>("rho", std::array{64., 65., 66., 67., 68., 69., 70., 71., 72.});

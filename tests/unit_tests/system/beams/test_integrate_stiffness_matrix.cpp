...
void TestIntegrateStiffnessMatrix_1Element1Node1QP(
    ...
    const Kokkos::View<double[1][6][6]>::const_type& qp_Quu, const std::array<double, 36>& exact_M_data,
    ...
    const auto shape_interp = CreateView<double[number_of_nodes][number_of_qps]>("shape_interp", std::array{4.});
    const auto shape_interp_deriv = CreateView<double[number_of_nodes][number_of_qps]>("shape_interp_deriv", std::array{5.});
...
constexpr std::array<double, 36> OneElement1Node1QP_Data() {
    return {0001., 0002., 0003., 0004., 0005., 0006., 1001., 1002., 1003., 1004., 1005., 1006., 2001., 2002., 2003., 2004., 2005., 2006., 3001., 3002., 3003., 3004., 3005., 3006., 4001., 4002., 4003., 4004., 4005., 4006., 5001., 5002., 5003., 5004., 5005., 5006.};
}
...
constexpr std::array<double, 36> OneElement1Node1QP_Cuu_Data() {
    return {03003., 03006., 03009., 03012., 03015., 03018., 06003., 06006., 06009., 06012., 06015., 06018., 09003., 09006., 09009., 09012., 09015., 09018., 12003., 12006., 12009., 12012., 12015., 12018., 15003., 15006., 15009., 15012., 15015., 15018., 18003., 18006., 18009., 18012., 18015., 18018.};
}
...
void TestIntegrateStiffnessMatrix_1Element1Node1QP_Cuu() {
    ...
    const auto qp_Puu = Kokkos::View<double[number_of_qps][6][6]>("Puu");
    const auto qp_Quu = Kokkos::View<double[number_of_qps][6][6]>("Quu");
    const auto qp_Cuu = CreateView<double[number_of_qps][6][6]>("qp_Cuu", OneElement1Node1QP_Cuu_Data());
    const auto qp_Ouu = Kokkos::View<double[number_of_qps][6][6]>("Ouu");
...
constexpr std::array<double, 36> OneElement1Node1QP_Ouu_Data() {
    return {1001., 1002., 1003., 1004., 1005., 1006., 2001., 2002., 2003., 2004., 2005., 2006., 3001., 3002., 3003., 3004., 3005., 3006., 4001., 4002., 4003., 4004., 4005., 4006., 5001., 5002., 5003., 5004., 5005., 5006., 6001., 6002., 6003., 6004., 6005., 6006.};
}
...
void TestIntegrateStiffnessMatrix_1Element1Node1QP_Ouu() {
    ...
    const auto qp_Quu = Kokkos::View<double[number_of_qps][6][6]>("Quu");
    const auto qp_Cuu = Kokkos::View<double[number_of_qps][6][6]>("Cuu");
    const auto qp_Ouu = CreateView<double[number_of_qps][6][6]>("qp_Ouu", OneElement1Node1QP_Ouu_Data());
...
void TestIntegrateStiffnessMatrix_1Element2Nodes1QP(
    ...
    const Kokkos::View<double[1][6][6]>::const_type& qp_Cuu,
    const Kokkos::View<double[1][6][6]>::const_type& qp_Ouu,
    const Kokkos::View<double[1][6][6]>::const_type& qp_Quu, const std::array<double, 144>& exact_M_data
) {
    ...
    const auto shape_interp = CreateView<double[number_of_nodes][number_of_qps]>("shape_interp", std::array{1., 2.});
    const auto shape_interp_deriv = CreateView<double[number_of_nodes][number_of_qps]>("shape_deriv", std::array{1., 4.});
...
constexpr std::array<double, 36> OneElement2Nodes1QP_Data() {
    return {0001., 0002., 0003., 0004., 0005., 0006., 0101., 0102., 0103., 0104., 0105., 0106., 0201., 0202., 0203., 0204., 0205., 0206., 0301., 0302., 0303., 0304., 0305., 0306., 0401., 0402., 0403., 0404., 0405., 0406., 0501., 0502., 0503., 0504., 0505., 0506.};
}

void TestIntegrateStiffnessMatrix_1Element2Nodes1QP_Puu() {
    constexpr auto number_of_qps = 1;

    const auto qp_Puu = CreateView<double[number_of_qps][6][6]>("qp_Puu", OneElement2Nodes1QP_Data());
    const auto qp_Kuu = Kokkos::View<double[number_of_qps][6][6]>("Kuu");
    const auto qp_Quu = Kokkos::View<double[number_of_qps][6][6]>("Quu");
    const auto qp_Cuu = Kokkos::View<double[number_of_qps][6][6]>("Cuu");
    const auto qp_Ouu = Kokkos::View<double[number_of_qps][6][6]>("Ouu");
...
void TestIntegrateStiffnessMatrix_1Element2Nodes1QP_Quu() {
    ...
    const auto qp_Kuu = Kokkos::View<double[number_of_qps][6][6]>("Kuu");
    const auto qp_Puu = Kokkos::View<double[number_of_qps][6][6]>("Puu");
    const auto qp_Quu = CreateView<double[number_of_qps][6][6]>("qp_Quu", OneElement2Nodes1QP_Data());
    const auto qp_Cuu = Kokkos::View<double[number_of_qps][6][6]>("Cuu");
    const auto qp_Ouu = Kokkos::View<double[number_of_qps][6][6]>("Ouu");
...
void TestIntegrateStiffnessMatrix_1Element2Nodes1QP_Cuu() {
    ...
    const auto qp_Puu = Kokkos::View<double[number_of_qps][6][6]>("Puu");
    const auto qp_Quu = Kokkos::View<double[number_of_qps][6][6]>("Quu");
    const auto qp_Cuu = CreateView<double[number_of_qps][6][6]>("qp_Cuu", OneElement2Nodes1QP_Data());
    const auto qp_Ouu = Kokkos::View<double[number_of_qps][6][6]>("Ouu");
...
void TestIntegrateStiffnessMatrix_1Element2Nodes1QP_Ouu() {
    ...
    const auto qp_Quu = Kokkos::View<double[number_of_qps][6][6]>("Quu");
    const auto qp_Cuu = Kokkos::View<double[number_of_qps][6][6]>("Cuu");
    const auto qp_Ouu = CreateView<double[number_of_qps][6][6]>("qp_Ouu", OneElement2Nodes1QP_Data());
...
void TestIntegrateStiffnessMatrix_1Element1Node2QPs(
    ...
    const Kokkos::View<double[2][6][6]>::const_type& qp_Quu, const std::array<double, 36>& exact_M_data
) {
    constexpr auto number_of_nodes = size_t{1U};
    constexpr auto number_of_simd_nodes = size_t{1U};
    ...
    const auto shape_interp = CreateView<double[number_of_nodes][number_of_qps]>("shape_interp", std::array{1., 1.});
    const auto shape_interp_deriv = CreateView<double[number_of_nodes][number_of_qps]>("shape_interp_deriv", std::array{1., 1.});
...
constexpr std::array<double, 72> OneElement1Node2QPs_Data() {
    return {10001., 10002., 10003., 10004., 10005., 10006., 10101., 10102., 10103., 10104., 10105., 10106., 10201., 10202., 10203., 10204., 10205., 10206., 10301., 10302., 10303., 10304., 10305., 10306., 10401., 10402., 10403., 10404., 10405., 10406., 10501., 10502., 10503., 10504., 10505., 10506., 20001., 20002., 20003., 20004., 20005., 20006., 20101., 20102., 20103., 20104., 20105., 20106., 20201., 20202., 20203., 20204., 20205., 20206., 20301., 20302., 20303., 20304., 20305., 20306., 20401., 20402., 20403., 20404., 20405., 20406., 20501., 20502., 20503., 20504., 20505., 20506.};
}

void TestIntegrateStiffnessMatrix_1Element1Node2QPs_Puu() {
    constexpr auto number_of_qps = 2;

    const auto qp_Puu = CreateView<double[number_of_qps][6][6]>("qp_Puu", OneElement1Node2QPs_Data());
    const auto qp_Kuu = Kokkos::View<double[number_of_qps][6][6]>("Kuu");
    const auto qp_Quu = Kokkos::View<double[number_of_qps][6][6]>("Quu");
    const auto qp_Cuu = Kokkos::View<double[number_of_qps][6][6]>("Cuu");
    const auto qp_Ouu = Kokkos::View<double[number_of_qps][6][6]>("Ouu");
...
void TestIntegrateStiffnessMatrix_1Element1Node2QPs_Quu() {
    ...
    const auto qp_Quu = CreateView<double[number_of_qps][6][6]>("qp_Quu", OneElement1Node2QPs_Data());
    const auto qp_Cuu = Kokkos::View<double[number_of_qps][6][6]>("Cuu");
    const auto qp_Ouu = Kokkos::View<double[number_of_qps][6][6]>("Ouu");

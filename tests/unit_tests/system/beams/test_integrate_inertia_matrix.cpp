...
inline void IntegrateInertiaMatrix_TestOneElementOneNodeOneQP_Muu() {
    ...
    const auto shape_interp = CreateView<double[number_of_nodes][number_of_qps]>("shape_interp", std::array{5.});
    const auto qp_Muu = CreateView<double[number_of_qps][6][6]>("qp_Muu", std::array{0001., 0002., 0003., 0004., 0005., 0006., 1001., 1002., 1003., 1004., 1005., 1006., 2001., 2002., 2003., 2004., 2005., 2006., 3001., 3002., 3003., 3004., 3005., 3006., 4001., 4002., 4003., 4004., 4005., 4006., 5001., 5002., 5003., 5004., 5005., 5006.});
    const auto qp_Guu = CreateView<double[number_of_qps][6][6]>("qp_Guu", std::array{1001., 1002., 1003., 1004., 1005., 1006., 2001., 2002., 2003., 2004., 2005., 2006., 4001., 4002., 4003., 4004., 4005., 4006., 5001., 5002., 5003., 5004., 5005., 5006., 6001., 6002., 6003., 6004., 6005., 6006., 7001., 7002., 7003., 7004., 7005., 7006.});
...
void IntegrateInertiaMatrix_TestOneElementOneNodeOneQP_Guu() {
    ...
    const auto shape_interp = CreateView<double[number_of_nodes][number_of_qps]>("shape_interp", std::array{5.});
    const auto qp_Muu = CreateView<double[number_of_qps][6][6]>("qp_Muu", std::array{0001., 0002., 0003., 0004., 0005., 0006., 1001., 1002., 1003., 1004., 1005., 1006., 2001., 2002., 2003., 2004., 2005., 2006., 3001., 3002., 3003., 3004., 3005., 3006., 4001., 4002., 4003., 4004., 4005., 4006., 5001., 5002., 5003., 5004., 5005., 5006.});
    const auto qp_Guu = CreateView<double[number_of_qps][6][6]>("qp_Guu", std::array{1001., 1002., 1003., 1004., 1005., 1006., 2001., 2002., 2003., 2004., 2005., 2006., 3001., 3002., 3003., 3004., 3005., 3006., 4001., 4002., 4003., 4004., 4005., 4006., 5001., 5002., 5003., 5004., 5005., 5006., 6001., 6002., 6003., 6004., 6005., 6006.});
...
void IntegrateInertiaMatrix_TestOneElementTwoNodesOneQP() {
    ...
    const auto qp_Muu = CreateView<double[number_of_qps][6][6]>("qp_Muu", std::array{001., 002., 003., 004., 005., 006., 101., 102., 103., 104., 105., 106., 201., 202., 203., 204., 205., 206., 301., 302., 303., 304., 305., 306., 401., 402., 403., 404., 405., 406., 501., 502., 503., 504., 505., 506.});
...
void IntegrateInertiaMatrix_TestOneElementOneNodeTwoQPs() {
    ...
    const auto shape_interp = CreateView<double[number_of_nodes][number_of_qps]>("shape_interp", std::array{1. / 3., 1. / 2.});
    const auto qp_Muu = CreateView<double[number_of_qps][6][6]>("qp_Muu", std::array{00001., 00002., 00003., 00004., 00005., 00006., 00011., 00012., 00013., 00014., 00015., 00016., 00021., 00022., 00023., 00024., 00025., 00026., 00031., 00032., 00033., 00034., 00035., 00036., 00041., 00042., 00043., 00044., 00045., 00046., 00051., 00052., 00053., 00054., 00055., 00056., 01000., 02000., 03000., 04000., 05000., 06000., 11000., 12000., 13000., 14000., 15000., 16000., 21000., 22000., 23000., 24000., 25000., 26000., 31000., 32000., 33000., 34000., 35000., 36000., 41000., 42000., 43000., 44000., 45000., 46000., 51000., 52000., 53000., 54000., 55000., 56000.});
    const auto qp_Guu = Kokkos::View<double[number_of_qps][6][6]>("Guu");
...
void IntegrateInertiaMatrix_TestOneElementOneNodeOneQP_WithMultiplicationFactor() {
    ...
    const auto qp_weights = CreateView<double[number_of_qps]>("weights", std::array{1.});
    const auto qp_jacobian = CreateView<double[number_of_qps]>("jacobian", std::array{1.});
    const auto shape_interp = CreateView<double[number_of_nodes][number_of_qps]>("shape_interp", std::array{1.});
    const auto qp_Muu = CreateView<double[number_of_qps][6][6]>("qp_Muu", std::array{0001., 0002., 0003., 0004., 0005., 0006., 1001., 1002., 1003., 1004., 1005., 1006., 2001., 2002., 2003., 2004., 2005., 2006., 3001., 3002., 3003., 3004., 3005., 3006., 4001., 4002., 4003., 4004., 4005., 4006., 5001., 5002., 5003., 5004., 5005., 5006.});
    const auto qp_Guu = Kokkos::View<double[number_of_qps][6][6]>("Guu");

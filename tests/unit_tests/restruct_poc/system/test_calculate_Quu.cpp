...
TEST(CalculateQuuTests, OneNode) {
    ...
    const auto M_tilde_host =
        Kokkos::View<const double[1][3][3], Kokkos::HostSpace>(M_tilde_data.data());
    ...
    const auto N_tilde_host =
        Kokkos::View<const double[1][3][3], Kokkos::HostSpace>(N_tilde_data.data());
    ...
    const auto Quu = Kokkos::View<double[1][6][6]>("Quu");
    ...
    const auto Quu_exact =
        Kokkos::View<const double[1][6][6], Kokkos::HostSpace>(Quu_exact_data.data());

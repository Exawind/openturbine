...
TEST(InterpolateQPVectorTests, OneNodeOneQP) {
    ...
    Kokkos::parallel_for(num_qp, InterpolateQPVector{first_qp, first_node, num_nodes, shape_interp, Kokkos::subview(node_u_dot, Kokkos::ALL, Kokkos::pair(0, 3)), qp_u_dot});

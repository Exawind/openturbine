...
TEST(BeamsTest, InitializeBeamsStruct) {
    ...
    openturbine::gen_alpha_solver::tests::expect_kokkos_view_2D_equal(
        ...
        {{2.000000000000001, 5.204170427930421e-17, -5.551115123125783e-17, -4.163336342344337e-17,
          0.626052147258804, -0.3395205571349214},
    ...
    // Stiffness matrix in global frame
    openturbine::gen_alpha_solver::tests::expect_kokkos_view_2D_equal(
        beams.qp_strain, {{0.0009414876868373279, -0.00048382928348705834, 0.0018188281296873943,
                           0.0184996868523541, 0.0, 0.0},
                          {0.004999015404948959, -0.002842341990545394, 0.008261426556751703,
                           0.019340884211946498, 0.0, 0.0},
                          {0.01186347151620959, -0.007712921718478594, 0.014194364820045248,
                           0.0199669691313353, 0.0, 0.0},
                          {0.019245008972987532, -0.014189235354885782, 0.01227275220904131,
                           0.019245008946139657, 0.0, 0.0},
                          {0.024398914449306308, -0.01980612763870543, 0.0017371550623738186,
                           0.01735533564038205, 0.0, 0.0},
                          {0.02701311486024094, -0.023330205052589426, -0.010887645811743119,
                           0.015511129011186278, 0.0, 0.0},
                          {0.02807406883607877, -0.02502305729533416, -0.019618382135299595,
                           0.014403547695422242, 0.0, 0.0}}
    );
}

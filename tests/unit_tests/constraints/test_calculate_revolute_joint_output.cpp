...
TEST(CalculateRevoluteJointOutputTests, OneConstraint) {
    ...
    constexpr auto node_x0_host_data =
        std::array{0., 0., 0., 0., 0., 0., 0., 11., 12., 13., 14., 15., 16., 17.};
    const auto node_x0_host =
        Kokkos::View<double[2][7], Kokkos::HostSpace>::const_type(node_x0_host_data.data());
    ...
    constexpr auto node_u_host_data =
        std::array{0., 0., 0., 0., 0., 0., 0., 18., 19., 20., 21., 22., 23., 24.};
    ...
    constexpr auto node_udot_host_data =
        std::array{0., 0., 0., 0., 0., 0., 25., 26., 27., 28., 29., 30.};
    const auto node_udot_host =
        Kokkos::View<double[2][6], Kokkos::HostSpace>::const_type(node_udot_host_data.data());

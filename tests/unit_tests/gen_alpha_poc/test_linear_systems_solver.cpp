...
TEST(LinearSolverTest, Solve1x1Identity) {
    ...
    openturbine::gen_alpha_solver::solve_linear_system(identity, solution);
...
TEST(LinearSolverTest, Solve1x1Diagonal) {
    ...
    openturbine::gen_alpha_solver::solve_linear_system(diagonal, solution);
...
TEST(LinearSolverTest, Solve2x2Matrix) {
    ...
    openturbine::gen_alpha_solver::solve_linear_system(matrix, solution);
...
TEST(LinearSolverTest, Check2x3MatrixShape) {
    ...
    EXPECT_THROW(
        openturbine::gen_alpha_solver::solve_linear_system(matrix_2x3, solution_2x1),
...
TEST(LinearSolverTest, Check5x3MatrixShape) {
    ...
    EXPECT_THROW(
        openturbine::gen_alpha_solver::solve_linear_system(matrix_5x3, solution_5x1),
        std::invalid_argument
    );
}
...
TEST(LinearSolverTest, Check1x1Matrix2x1VectorCompatibility) {
    ...
    EXPECT_THROW(
        openturbine::gen_alpha_solver::solve_linear_system(system_1x1, solution_2x1),
        std::invalid_argument
    );
}
...
TEST(LinearSolverTest, Check3x3Matrix2x1VectorCompatibility) {
    ...
    EXPECT_THROW(
        openturbine::gen_alpha_solver::solve_linear_system(system_3x3, solution_2x1),
        std::invalid_argument
    );
}

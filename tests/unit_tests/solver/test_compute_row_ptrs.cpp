...
TEST(ComputeRowPtrs, OneElementOneNode) {
    ...
    const auto num_nodes_per_element = CreateView<size_t[1]>("num_nods_per_element", std::array{1UL});
...
TEST(ComputeRowPtrs, OneElementTwoNodes) {
    ...
    const auto num_nodes_per_element = CreateView<size_t[1]>("num_nods_per_element", std::array{2UL});
...
TEST(ComputeRowPtrs, TwoElementTwoNodesNoOverlap) {
    ...
    const auto num_nodes_per_element = CreateView<size_t[2]>("num_nods_per_element", std::array{2UL, 2UL});

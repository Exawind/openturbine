...
TEST(UpdateGlobalPosition, OneNode) {
    ...
    const auto q_host = Kokkos::View<double[1][7], Kokkos::HostSpace>::const_type(q_host_data.data());
    ...
    const auto x0_host = Kokkos::View<double[1][7], Kokkos::HostSpace>::const_type(x0_host_data.data());
    ...
    const auto x_exact = Kokkos::View<double[1][7], Kokkos::HostSpace>::const_type(x_exact_data.data());

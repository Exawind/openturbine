...
TEST(TestCreateConstraintFreedomTable, SingleNodeConstraint_FixedBC) {
    ...
    const auto host_target_node_index = create_mirror_view_and_copy(Kokkos::HostSpace(), constraints.target_node_index);
    ...
    const auto host_target_node_freedom_table = create_mirror_view_and_copy(Kokkos::HostSpace(), constraints.target_node_freedom_table);
...
TEST(TestCreateConstraintFreedomTable, DoubeNodeConstraint_RigidBC) {
    ...
    const auto host_base_node_index = create_mirror_view_and_copy(Kokkos::HostSpace(), constraints.base_node_index);
    const auto host_target_node_index = create_mirror_view_and_copy(Kokkos::HostSpace(), constraints.target_node_index);
    ...
    const auto host_target_node_freedom_signature =
        create_mirror_view_and_copy(Kokkos::HostSpace(), constraints.target_node_freedom_signature);
    const auto host_base_node_freedom_table = create_mirror_view_and_copy(Kokkos::HostSpace(), constraints.base_node_freedom_table);
    const auto host_target_node_freedom_table = create_mirror_view_and_copy(Kokkos::HostSpace(), constraints.target_node_freedom_table);
